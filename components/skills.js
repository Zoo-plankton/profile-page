var skills = [
  {
    ...
    desc:"I'm familiar with <strong>SCSS</strong> & <strong>Jade</strong> pre-processors, but currently I really like using Emmet to create HTML in my <strong>Embedded JavaScript</strong> files.",
  },
  {
  ...
  },
  {
    ...
    desc:"I can create RESTful apps using <strong>Node.js</strong> and <strong>Express</strong>. I also have some experience using <strong>Passport</strong> for authentication and <strong>Git</strong> as a version control system.",
  },
  {
  ...
  },
  {
    ...
    desc:"I believe the desire to learn is important not only to those in the tech industry, but to everyone everywhere! I'm currently working to add <strong>Vuejs</strong> and <strong>PostgreSQL</strong> to my list.",
  },
];
