var skills = [
  {
    ...
    desc:"I'm familiar with <strong>SCSS</strong> & <strong>Jade</strong> pre-processors, but I prefer using Emmet to create HTML in <strong>Embedded JavaScript</strong> files.",
  },
  {
